...
echo "  • Dashboard with project management (add/remove)"
echo "  • In-app log viewer with error filtering"
echo "  • Schedule presets (work hours, hourly, etc.)"
echo "  • Alert you if daemon stops"
echo "  • Guided onboarding for first-time setup"
