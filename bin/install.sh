#!/bin/bash
# ClaudeCode Project Backups - Installation Script
...
echo "═══════════════════════════════════════════════"
echo "ClaudeCode Project Backups - Installation"
echo "═══════════════════════════════════════════════"
echo ""
...
cat > "$CONFIG_FILE" << EOF
#!/bin/bash
# ClaudeCode Project Backups - Configuration
...
if ! grep -q "^backups/$" "$GITIGNORE" 2>/dev/null; then
    echo "" >> "$GITIGNORE"
    echo "# ClaudeCode Project Backups" >> "$GITIGNORE"
